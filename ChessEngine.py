    ...
    def makeMove(self, move):
        ...
        if self.board[move.end_row][move.end_col] != "--":
            if self.white_to_move:
                if self.board[move.end_row][move.end_col][1] == 'p':
                    self.white_points += 1
                elif self.board[move.end_row][move.end_col][1] == 'R':
                    self.white_points += 5
                elif self.board[move.end_row][move.end_col][1] == 'N':
                    self.white_points += 3
                elif self.board[move.end_row][move.end_col][1] == 'B':
                    self.white_points += 3
                elif self.board[move.end_row][move.end_col][1] == 'Q':
                    self.white_points += 9
